(() => {
  ...
  function simpleThreshold(){
    ...
    let src = ctx2.getImageData(0, 0, canvas.width, canvas.height)
    let dst = ctx2.createImageData(canvas.width, canvas.height)
    ...
    function updateAudioFrequency(){
      ...
      ctx.fillStyle = 'rgb(0, ' + (126 + parseInt(((isWhite / total) - 0.5) * 800, 10 )) + ', 0)'
